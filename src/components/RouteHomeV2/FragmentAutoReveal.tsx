  ...
  return (
    <>
      <section className="relative bg-[#FCFCFC] overflow-hidden">
        ...
        <div className="w-full flex justify-center px-4 md:px-8 lg:px-12 py-16 md:pt-36 md:pb-36">
          <div className="w-full max-w-[1408px] 1600:max-w-[1500px] 1700:max-w-[1600px] 1800:max-w-[1700px] 1900:max-w-[1800px] 1920:max-w-[1900px] relative z-10">
            ...
            <div className="mb-4 relative">
              ...
              <h1 className="font-britti-sans font-normal text-[#202020] mb-6 break-words tracking-tight text-left text-[48px] leading-[54px] 600:text-[56px] 600:leading-[66px] 1300:text-[80px] 1300:leading-[80px] max-w-fit">
