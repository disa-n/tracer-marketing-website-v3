...
const PersonalizedDemoHome = () => {
  return (
    <section className="bg-[#FCFCFC]">
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 900:px-8 pt-6 sm:pt-16">
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end sm:gap-2 xl:gap-0">
          ...
          <div className="flex sm:justify-end">
            <button
              onClick={openDemo}
              className="flex h-[36px] w-full shrink-0 cursor-pointer items-center justify-center bg-[#E8E8E8] px-8 py-3 font-britti-sans text-sm font-normal text-[#202020] hover:bg-[#E8E8E8]/80 sm:w-auto sm:h-[51px] sm:text-base"
            >
              Talk to an Expert
            </button>
          </div>
