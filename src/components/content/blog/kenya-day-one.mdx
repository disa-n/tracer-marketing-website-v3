...
- We removed 55% of code from installation scripts, merged dev and prod scripts into one (reducing 450 lines of code), and reduced our database costs from <span className="font-normal">$14,700/month</span> to <span className="font-normal">$52.50/month</span>.  
