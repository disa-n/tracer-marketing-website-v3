...
Our industry is experiencing rapid transformation as millions of scientists leverage computational biology to accelerate and reduce the cost of lifescience research. This leads to biology software packages becoming more popular every day. For example, AlphaFold (an AI program that predicts protein structures) has been utilised by over [1.4 million researchers](https://deepmind.google/impact/meet-the-scientists-using-alphafold/). Last year, Bioconductor (software that analyses genomic data in wet lab experiments) was used by more than [1 million scientists](https://www.bioconductor.org/packages/stats/bioc/index.html), and the amount of downloads has already increased by [39% this year](https://www.bioconductor.org/packages/stats/bioc/index.html).
