...
export default function WhatWeDo() {
  return (
    <section className="relative overflow-hidden bg-[#1e1e1e] -mt-16 md:-mt-20 lg:-mt-24 xl:-mt-28 2xl:-mt-32">
      <div className="relative z-20 pt-56 pb-20 md:pt-56 md:pb-48 lg:pt-48 lg:pb-56 xl:pt-52 xl:pb-64 2xl:pt-72 2xl:pb-72">
      ...
      <div className="absolute right-0 top-0 md:top-0 xl:top-16 2xl:top-32 z-30">
