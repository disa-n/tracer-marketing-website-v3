...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen w-full bg-[#FCFCFC] font-britti-sans text-[#202020]">
      <main className="mx-auto max-w-[1200px] px-4 pt-32 pb-16 md:px-8 flex flex-col gap-[72px]">
        {/* Page Heading */}
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-normal">Terms and Conditions</h1>
        ...
        {/* Sections */}
        <section className="flex flex-col gap-12 text-base leading-relaxed font-normal max-w-[800px]">
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">1. Use of the Site</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">3. Disclaimers</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">4. Limitation of Liability</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">5. Third-Party Content</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">6. Modifications</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">7. Governing Law and Jurisdiction</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-normal mb-6">8. Contact Information</h2>
