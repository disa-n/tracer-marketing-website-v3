...
const Monitoring = () => {
    ...
    return (
        <div ref={containerRef} className='relative flex w-full flex-col items-center justify-center overflow-hidden'>
            <Image src={"/images/product/visuals-assets/monitoting-section-img.png"} alt="monitoting-section-img" width={955} height={800} className="absolute right-0 top-0 w-full max-w-[500px] -translate-y-14 translate-x-32 md:translate-x-20 md:translate-y-0 lg:max-w-[800px] lg:translate-x-32 1300:max-w-[955px] 1300:translate-x-40" />
