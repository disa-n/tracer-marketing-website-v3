      ...
      <div className='w-full flex z-[10] flex-col items-center justify-center max-w-[1800px] 900:px-8 px-6 mx-auto'>
        <div className="relative z-10 py-16 lg:py-28 w-full">
          ...
          <div className="mt-48">
            ...
            {/* Airflow */}
            <div className="flex items-center justify-center aspect-square w-full bg-[#202020] border border-[#303030] p-4">
              <img
                src="/platformv2/logos/airflow.svg"
                alt="Apache Airflow"
                className="w-full h-auto max-w-[120px] max-h-[60px] object-contain"
              />
            </div>
