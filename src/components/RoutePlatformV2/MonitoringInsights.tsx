                ...
                <div className='w-full mt-6 md:mt-[18px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[0.16fr_0.27fr_0.27fr_0.36fr] gap-4 md:gap-2'>
                    ...
                    <div className="flex flex-col">
                        <div className="overflow-hidden h-[200px] md:h-auto">
                            <Image src={"/product/industries/m-1.webp"} alt='' width={500} height={500} className='w-full h-full md:h-auto object-cover' style={{ objectPosition: 'center 60%' }} />
                        </div>
                    ...
                    <div className="flex flex-col">
                        <div className="overflow-hidden h-[200px] md:h-auto">
                            <Image src={"/product/industries/m-2.webp"} alt='' width={500} height={500} className='w-full h-full md:h-auto object-cover' />
                        </div>
                        <h3 className='mt-2 text-[24px] md:text-[40px] font-[400] tracking-tighter text-c-black leading-[1] font-britti-sans'>
                            Computational Fluid Dynamic
                        </h3>
                    ...
                    <div className="flex flex-col">
                        <div className="overflow-hidden h-[200px] md:h-auto">
                            <Image src={"/product/industries/m-3.webp"} alt='' width={500} height={500} className='w-full h-full md:h-auto object-cover' style={{ objectPosition: 'center 60%' }} />
                        </div>
                        <h3 className='mt-2 text-[24px] md:text-[40px] font-[400] tracking-tighter text-c-black leading-[1] font-britti-sans'>
                            Pharma & Biotech
                        </h3>
                    ...
                    <div className="flex flex-col">
                        <div className="overflow-hidden h-[200px] md:h-auto">
                            <Image src={"/product/industries/m-4.webp"} alt='' width={500} height={500} className='w-full h-full md:h-auto object-cover' />
                        </div>
                        <h3 className='mt-2 text-[24px] md:text-[40px] font-[400] tracking-tighter text-c-black leading-[1] font-britti-sans'>
                            Aerospace
                        </h3>
