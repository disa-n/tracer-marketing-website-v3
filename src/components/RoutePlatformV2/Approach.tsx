        ...
        <div className='bg-white pt-10 pb-4 md:py-[72px] w-full text-black border-t border-[#E8E8E8] flex items-center relative justify-center flex-col'>
            ...
            <div className='w-full flex z-[10]  flex-col items-center justify-center max-w-[1800px] 900:px-8 px-6'>
                ...
                >
                    ...
                    >
                        <Image src={"/images/product/icons/setting-icon.svg"} alt='setting-icon' width={65} height={65} className='shrink-0 aspect-square w-full max-w-[40px] sm:max-w-[56px]' />
                        <div className=''>
                    ...
                    <motion.div
                        ...
                        variants={cardVariants}
                    >
                        <Image src={"/images/product/icons/currency-dollar.svg"} alt='currency-dollar' width={65} height={65} className='shrink-0 aspect-square w-full max-w-[40px] sm:max-w-[56px]' />
                        <div className=''>
                    ...
                    <motion.div
                        ...
                        variants={cardVariants}
                    >
                        <Image src={"/images/product/icons/arrows-pointing-out.svg"} alt='arrows-pointing-out' width={65} height={65} className='shrink-0 aspect-square w-full max-w-[40px] sm:max-w-[56px]' />
                        <div className=''>
                            <h3 className='text-c-black font-[400] font-britti-sans text-[24px] md:text-[40px] leading-[1.1]'>
                                New Scale
                            </h3>
