            ...
            <div className='w-full max-w-[1440px] px-4 py-10 md:pt-36 md:pb-36'>
                <div className='md:gap-30 flex w-full flex-col items-center justify-center gap-12 border border-[#404040]'>
                    ...
                    <div className='w-full overflow-hidden border-[#404040] md:border-t 1200:h-[360px]'>
                        <Image src={"/product/partner-images/partner-img.png"} alt='partner-img.png' width={1400} height={380} className='hidden w-full max-w-[1480px] shrink-0 md:flex' />
                        <Image src={"/product/partner-images/partner-img-mb.png"} alt='partner-img.png' width={1400} height={380} className='w-full max-w-[1480px] shrink-0 md:hidden' />
                    </div>
                </div>
            </div>
        </div>
