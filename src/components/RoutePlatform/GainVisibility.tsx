        ...
        <div className='relative flex w-full flex-col items-center justify-center overflow-hidden bg-[#FCFCFC] pt-[56px] text-black md:pt-[127px]'>
            ...
            <div className='z-[10] w-full max-w-[1440px] px-4'>
                ...
                <div className='grid w-full gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-3'>
                    <AnimatedCard
                        iconSrc="/platform/icons/monitor.svg"
                        iconAlt="monitor"
                    ...
                    />
                    <AnimatedCard
                        iconSrc="/platform/icons/monitor-2.svg"
                        iconAlt="monitor-2"
                    ...
                    />
                    <AnimatedCard
                        iconSrc="/platform/icons/eye.svg"
                        iconAlt="eye"
                    ...
                    <div className='hidden md:flex' />
                    <AnimatedCard
                        iconSrc="/platform/icons/phone.svg"
                        iconAlt="phone"
                    ...
                    <div className='hidden md:flex' />
                    <AnimatedCard
                        iconSrc="/platform/icons/cloude.svg"
                        iconAlt="cloude"
                    ...
                    />
                    <AnimatedCard
                        iconSrc="/platform/icons/camera.svg"
                        iconAlt="camera"
            ...
            <motion.div
                ...
                initial="hidden"
                className='relative h-[216px] w-full md:h-[346px]'
            >
                <motion.div
                    animate={bottomImageControls}
                    variants={bottomImageVariants}
                    initial="hidden"
                    className='absolute bottom-[-60px] left-[-180px] md:bottom-[-105px] md:left-[-35px]'
                >
