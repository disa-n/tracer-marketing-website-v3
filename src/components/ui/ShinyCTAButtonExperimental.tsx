export default function ShinyCTAButtonExperimental({
  ...
  return (
    <a
      ...
      className={`shiny-cta-experimental flex items-center justify-center transition-all duration-500 ease-in-out ${wide ? 'sctebig-experimental' : 'sctesmall-experimental'} ${isScrolled !== undefined
        ? (isScrolled
          ? 'text-sm px-4 h-[35px]'
