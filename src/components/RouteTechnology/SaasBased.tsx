    ...
    return (
        <div className=' bg-white text-black'>
            ...
            <div className='mt-20 border-t border-b border-gray-200 h-auto lg:h-20 flex flex-col lg:flex-row justify-start items-center px-6'>
                ...
                <div className='w-full lg:w-20 border-t lg:border-r border-gray-200 h-10 lg:h-20'></div>
                <div className='hidden lg:block w-full lg:w-40 border-t lg:border-r border-gray-200 h-20'></div>
                <div className='flex-1 border-r border-gray-200 h-20'></div>
            </div>
            <div className='border-b border-gray-200 h-auto lg:h-20 flex flex-col lg:flex-row justify-start items-center px-6'>
                ...
                <div className='hidden lg:block w-20 border-r border-gray-200 h-20'></div>
                <div className='hidden lg:block w-40 border-r border-gray-200 h-20'></div>
                <div className="w-full lg:flex-1 border-r border-l lg:border-l-0 border-gray-200 h-auto lg:h-20">
            ...
            <div className='border-b border-gray-200 h-auto lg:h-20 flex flex-col lg:flex-row justify-start items-center lg:px-6'>
                ...
                <div className='w-full lg:w-20 border-l lg:border-l-0 border-r border-gray-200 h-10 lg:h-20'></div>
                <div className='hidden lg:block w-40 border-r border-gray-200 h-20'></div>
                <div className='w-full border-t lg:border-t-0 lg:flex-1 border-r border-gray-200 h-20 flex items-center px-6 lg:px-0'>
                    <div className='w-full lg:w-24 lg:border-l-0 border-l border-r border-gray-200 h-20 flex justify-center items-center'><Image src="/technology/hipaa.png" alt='HIPAA' width={82} height={42} className='w-[82px] h-[42px]' /></div>
                    <div className='w-full lg:w-20 border-r border-gray-200 h-20 flex justify-center items-center'><Image src="/technology/gdpr.png" alt='GDPR' width={48} height={48} className='w-[48px] h-[48px]' /></div>
                    <div className='w-full lg:w-20 border-r border-gray-200 h-20 flex justify-center items-center'><Image src="/technology/dod.png" alt='DOD' width={48} height={48} className='w-[48px] h-[48px]' /></div>
                </div>
            </div>
            <div className='border-b border-gray-200 h-auto lg:h-20 flex flex-col lg:flex-row justify-normal lg:justify-start items-center px-0 lg:px-6'>
                ...
                <div className='w-full border-b lg:border-b-0 lg:w-20 border-r-0 lg:border-r border-gray-200 h-10 lg:h-20'></div>
                <div className='w-full border-r border-l lg:border-r-0 lg:border-l-0 border-gray-200 lg:flex-1 h-auto lg:h-20 px-6'>
