        ...
        <div className="pt-6 sm:pt-16">
          <div className="px-4">
            <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end sm:gap-2 xl:gap-0">
              ...
              <button
                onClick={openDemo}
                className="flex h-[36px] w-full cursor-pointer items-center justify-center bg-[#E8E8E8] px-8 py-3 font-britti-sans text-sm font-normal text-[#202020] hover:bg-[#E8E8E8]/80 sm:w-auto sm:h-[51px] sm:text-base"
              >
                Talk to an Expert
              </button>
            </div>
